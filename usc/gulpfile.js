...
gulp.task('default', ['watch','js-libs','ng-libs','app-common-min-js','app-components-js','app-common-js','app-common-html','app-components-html','app-components-styles','css-libs','assets-styles','fontmin','imagemin']);
...
gulp.task('ng-libs', function() {
    gulp.src([
            ...
            "src/assets/vendor/angular-dragdrop/src/angular-dragdrop.min.js",
            ...
            "src/assets/vendor/paper/dist/paper-full.js",
            "src/assets/vendor/fabric/dist/fabric.js",
             "src/assets/vendor/paper/dist/paper-core.min.js",
...
gulp.task('css-libs', function() {
  gulp.src([
    'src/assets/vendor/jquery-ui/themes/ui-lightness/jquery-ui.min.css',
